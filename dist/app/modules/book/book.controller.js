...
const createComment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_service_1.BookService.createComment(id, commentData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getAllBooks = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_service_1.BookService.getAllBooks(filters, paginationOption);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSpecificAllBooks = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userEmail = req.params.userEmail;
    const result = yield book_service_1.BookService.getSpecificAllBooks(userEmail);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (((_b = (_a = validUser === null || validUser === void 0 ? void 0 : validUser.user) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) !== ((_c = req === null || req === void 0 ? void 0 : req.user) === null || _c === void 0 ? void 0 : _c._id)) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'This is not your Book');
    }
...
const deleteBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const validUser = yield book_model_1.Book.findById(id).populate('user');
    if (((_e = (_d = validUser === null || validUser === void 0 ? void 0 : validUser.user) === null || _d === void 0 ? void 0 : _d._id) === null || _e === void 0 ? void 0 : _e.toString()) !== ((_f = req === null || req === void 0 ? void 0 : req.user) === null || _f === void 0 ? void 0 : _f._id)) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'This is not your book');
    }
