...
router.post('/', (0, validateRequest_1.default)(book_validation_1.BookValidation.bookZodSchema), book_controller_1.BookController.createBook);
router.post('/comment/:id', book_controller_1.BookController.createComment);
router.get('/', book_controller_1.BookController.getAllBooks);
router.get('/my-book/:userEmail', book_controller_1.BookController.getSpecificAllBooks);
